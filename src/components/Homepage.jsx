        ...
        <Box sx={{ flex: 1, minHeight: 0, overflowY: "auto" }}>
          <Box sx={{ display: "flex", gap: 2, mb: 0.3 }}>
            ...
            >
              ...
              <Typography sx={{ mb: 2, fontSize: { xs: 10, md: 12 } }}>
          ...
          >
            ...
            >
              ...
              >
                <Typography variant="p" sx={{ fontWeight: 600, fontSize: { xs: 13, md: 16 } }}>
                  Recent Applications:
                </Typography>
                <Link
                ...
                >
                  ...
                  <ArrowForwardIcon
                    sx={{ width: { xs: "13px", md: "16px" }, height: { xs: "13px", md: "16px" } }}
                  />
                </Link>
              </Box>
            ...
            >
              <Typography variant="p" sx={{ mb: 3, fontWeight: 600, fontSize: { xs: 13, md: 16 } }}>
